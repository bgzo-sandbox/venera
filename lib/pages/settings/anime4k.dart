...
class _Anime4KSettingsState extends State<Anime4KSettings> {
  ...
  Widget build(BuildContext context) {
    return SmoothCustomScrollView(
      slivers: [
        SliverAppbar(title: Text('Anime4K')),
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Anime4K 更适合线稿、漫画和彩漫边缘增强。对原图本身就很糊、压缩严重的图片，提升通常有限。',
        ...
        _SwitchSetting(
          ...
          subtitle: '开启后，阅读器会在后台对图片进行处理，并在处理完成后替换显示。',
          onChanged: () {
            setState(() {});
          },
        ).toSliver(),
        if (appdata.settings['enableAnime4K'] == true)
          _SwitchSetting(
            ...
            subtitle: '在线阅读时也执行 Anime4K。会增加加载后的处理时间和内存占用。',
            onChanged: () {
              setState(() {});
            },
          ).toSliver(),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '先把放大倍率设为 2.0，再微调“线条细化强度”和“边缘精炼强度”。如果图片本身是低质量压缩图，Anime4K 不能把它恢复成高清原图。',
                style: ts.s12.copyWith(
                  color: context.colorScheme.onSurfaceVariant,
                ),
              ),
